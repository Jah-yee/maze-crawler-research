"""
v66: v37 + proactive late-game worker build.

ALL top-15 teams build at least 1 worker (average 0.64-5.12).
We build 0 workers. This is our #1 identifying fingerprint.

Worker serves as:
- Energy buffer (300 max energy) for timeout tiebreak
- Wall removal capability (REMOVE_NORTH)
- Extra unit count for tiebreak resolution

Added: proactive worker build when gap > 10 and energy >= 500 (step >= 250).
"""
