"""
v21 Maze Crawler Agent: 24-step delayed scout with idle-turn side mine economy.
            ...
            if factory_uid in actions:
                ...
                for d in ("NORTH",):
                    ...
                    if mpos in own_mines and can_move(factory_col, factory_row, d) and safe_factory_action(d):
                        ...
                        break
                if factory_uid not in actions and factory_gap > SIDE_MINE_COLLECT_MIN_GAP:
                    for d in ("EAST", "WEST"):
                        dc, dr = OFFSETS[d]
                        mpos = (factory_col + dc, factory_row + dr)
                        if mpos in own_mines and can_move(factory_col, factory_row, d) and safe_factory_action(d):
