"""
v122: v121 without near-terminal worker bailout.

Keep v121's route logic intact. Remove the low-gap BUILD_WORKER fallback so the
factory never spends a near-death turn on a support build.
"""
import hashlib
