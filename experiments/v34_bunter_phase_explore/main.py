"""
v34 Maze Crawler Agent: v24 plus bunterrrrr-inspired phase tuning.
Key ideas: jump-preferred BFS, mirror vision, optimistic fog, emergency escape,
an early no-scout window for mine conversion, lighter late scout rebuilding,
and forced-idle side mine creation as an exploration branch.
"""
...
SIDE_MINE_COLLECT_MIN_GAP = 20
SIDE_MINE_COLLECT_MAX_ENERGY = 700
