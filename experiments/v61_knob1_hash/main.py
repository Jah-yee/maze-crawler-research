"""
v61_knob1_hash: v37 + P01 Knob1 fix + anti-IL hash perturbation (D03 from v49).

Built on v57 (Knob 1 fix: enemy factory's current cell unconditionally blocked).
Adds player-asymmetric BFS direction order (D01/D02) and ~30% hash-based
lateral-order perturbation (D03) from v49, gated at factory_gap > 6.
"""
import hashlib
