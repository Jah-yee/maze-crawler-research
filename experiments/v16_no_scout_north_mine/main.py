"""
v16 Maze Crawler Agent: no-scout north mine economy.
Key ideas: jump-preferred BFS, mirror vision, optimistic fog, emergency escape,
and bunterrrrr-style north-adjacent mine conversion without routine scouts.
"""
...
def _agent_inner(obs, config):
    ...
    if factory_uid not in actions:
        ...
        if mine_build_action:
            ...
            counts[MINER] += 1
        elif ENABLE_SCOUT_BUILD and spawn_ok and counts[SCOUT] < 1 and factory_energy >= 50:
