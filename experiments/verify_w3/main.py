"""
verify_w3: v37 + W3 undirected BUILD_MINER probe.

Minimal diff from v37: the BUILD_MINER_NORTH action string is replaced with
the legacy undirected BUILD_MINER. Per env README this defaults to north,
so this is expected to be a near-no-op — useful as a paired_eval noise floor.
