"""
v118: v67 + idle-slot second scout support bank.

Keep the first scout and miner logic unchanged. Add only one route-safe second
scout when the factory is on a move-cooldown idle turn and has enough economy
to buy cheap support/tiebreak insurance without stealing a movement step.
"""
import hashlib
