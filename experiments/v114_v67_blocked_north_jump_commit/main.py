"""
v114: v67 + blocked-NORTH jump ownership commit.

Single-variable candidate: when the factory planned NORTH under route pressure
but the north cell is held by an IDLE friendly support, preserve factory route
ownership with a safe JUMP_NORTH if its landing is clear. Support behavior,
economy, and all other v67 decisions stay unchanged.
"""
import hashlib
