"""
v22 Maze Crawler Agent: conservative side collection for idle-turn side mines.
...
SCOUT_DELAY_STEP = 24
SIDE_MINE_MIN_ENERGY = 900
SIDE_MINE_MIN_GAP = 12
SIDE_MINE_COLLECT_MIN_GAP = 17
SIDE_MINE_COLLECT_MAX_ENERGY = 900
        ...
        if mine_build_action:
            ...
            if factory_uid in actions:
                ...
                if (
                    ...
                    and factory_gap > SIDE_MINE_COLLECT_MIN_GAP
                    and factory_energy < SIDE_MINE_COLLECT_MAX_ENERGY
                ):
                    for d in ("EAST", "WEST"):
                        dc, dr = OFFSETS[d]
                        mpos = (factory_col + dc, factory_row + dr)
