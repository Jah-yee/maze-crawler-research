"""
v110: v67 + Final Kick routine spend gate.

Keeps v67 player-asymmetric/hash path perturbation unchanged, but blocks
routine miner/scout builds in Final Kick (turn >= 400 or factory_gap <= 4).
Movement ladder and last-resort emergency worker remain unchanged.
"""
import hashlib
...
def _agent_inner(obs, config):
    ...
    final_kick = turn >= 400 or factory_gap <= 4
